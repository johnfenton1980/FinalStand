...
UNREALROOTPATH = /home/john/1TBDrive/unreal/UnrealEngine
GAMEPROJECTFILE =/home/john/256GBDrive/Unreal Projects/FinalStand/FinalStand.uproject
...
TARGETS = \
	...
	UnrealServer \
	FinalStand-Linux-Debug  \
	FinalStand-Linux-DebugGame  \
	FinalStand-Linux-Test  \
	FinalStand-Linux-Shipping  \
	FinalStand \
	FinalStandEditor-Linux-Debug  \
	FinalStandEditor-Linux-DebugGame  \
	FinalStandEditor-Linux-Test  \
	FinalStandEditor-Linux-Shipping  \
	FinalStandEditor \
	FinalStandServer-Linux-Debug  \
	FinalStandServer-Linux-DebugGame  \
	FinalStandServer-Linux-Test  \
	FinalStandServer-Linux-Shipping  \
	FinalStandServer\
	configure
...
FinalStand-Linux-Debug:
	 $(PROJECTBUILD) FinalStand Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

FinalStand-Linux-DebugGame:
	 $(PROJECTBUILD) FinalStand Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

FinalStand-Linux-Test:
	 $(PROJECTBUILD) FinalStand Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

FinalStand-Linux-Shipping:
	 $(PROJECTBUILD) FinalStand Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

FinalStand:
	 $(PROJECTBUILD) FinalStand Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

FinalStandEditor-Linux-Debug:
	 $(PROJECTBUILD) FinalStandEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

FinalStandEditor-Linux-DebugGame:
	 $(PROJECTBUILD) FinalStandEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

FinalStandEditor-Linux-Test:
	 $(PROJECTBUILD) FinalStandEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

FinalStandEditor-Linux-Shipping:
	 $(PROJECTBUILD) FinalStandEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

FinalStandEditor:
	 $(PROJECTBUILD) FinalStandEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

FinalStandServer-Linux-Debug:
	 $(BUILD) FinalStandServer Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

FinalStandServer-Linux-DebugGame:
	 $(BUILD) FinalStandServer Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

FinalStandServer-Linux-Test:
	 $(BUILD) FinalStandServer Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

FinalStandServer-Linux-Shipping:
	 $(BUILD) FinalStandServer Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

FinalStandServer:
	 $(BUILD) FinalStandServer Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
